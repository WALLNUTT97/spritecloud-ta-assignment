...
This project contains API tests written in TypeScript using Playwright, targeting: - Front end Flows (https://www.saucedemo.com) - API Flows (https://dummyjson.com)
