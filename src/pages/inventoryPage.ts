...
import { SauceDemoProductInfo, SortDirections } from '../data/sauceDemoProducts';
...
export class InventoryPage {
  constructor(private readonly page: Page) {}
    ...
    async compareProductNameOrder(gatheredProductNames: string[], direction: string): Promise<void> {
        ...
        async compareProductPriceOrder(gatheredProductPrices: number[], direction: string): Promise<void> {
